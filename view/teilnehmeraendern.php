...
<table>
    <tbody>
        ...
        <tr>
                <td>Geschlecht</td>
                <td><input name="geschlecht" value="m" type="radio" <?php echo HTML::checked($t->getGeschlecht(),'m'); ?> >männlich
                    <input name="geschlecht" value="w" type="radio" <?php echo HTML::checked($t->getGeschlecht(),'w'); ?> >weiblich
                    <input name="geschlecht" value="d" type="radio" <?php echo HTML::checked($t->getGeschlecht(),'d'); ?> >divers
                </td>
        </tr>
        <tr>
            <td>Telefonnummer</td>
